   ...
   */
    public boolean equals(Object obj){
        ...
        if (obj instanceof Date){
            return ((Date) obj).getDate().equals(currDate);
        }
            ...
            try{
                return new Date((String) obj).equals(currDate);
            }
            catch(ParseException e){}
        }
        return false;
   ...
   */
    private static class DateComparer implements java.util.Comparator {
        ...
        public final int compare(Object a, Object b){
            ...
            else if (a instanceof Date) d1 = ((Date) a).getDate();

            if (b instanceof java.util.Date) d2 = ((java.util.Date) b);
            else if (b instanceof Date) d2 = ((Date) b).getDate();
